...
Ensuite, installez la fléchette à l'aide de la commande ci-dessous.
...
Pour définir le chemin de la fléchette, copiez et collez cette commande sur votre terminal.
...
dart --version
```
Dart est installée avec succès sur votre système si elle vous donne un code de version.
